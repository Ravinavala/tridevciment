...
<div class="row awl-spacing-md" id="update_div">
    <div class="container">
        ...
        <div  id="cat-table-div" class="<?php if ($action != "add" && $action != "update") echo'form-style-5'; ?>">
            ...
            <?php if (count($all_category) == 20) { ?>
                <h5 class="notice notice-info notice-alt"><?php _e('You can only add 20 category in free version for more upgrade to our pro version', PFG_TXTDM); ?></h5>
            <?php } ?>
        </div>
    </div>
</div>
